 ...
 *    PROG ON: Modo de programação
 *    PROG OFF: Modo normal
 *    
 ...
 *    MODO 4 | MODO 5 | MODO 6 | PROG ON | PROG OFF | BOTÃO 6 (pressionado)
 *    
 * Para programar um patch numa posição do FS: 
 *  1- Selecione o modo de programação (led do FS irá piscar)
 *  2- Selecione o patch na pedaleira da ZOOM
 *  3- Aperte o botão do FS que deseja associar (led irá piscar mais rápido indicando que progamou)
 */
...
char bt_mode=4;     //4 - modo de 4 botões de patch / 5 - modo de 5 botões de patch / 6 - modo de 6 botões de patch 
